...
const SportTop = () => {
  const topEvent = data.filter((d) => d.top == true);
  return (
    <div>
      <p className="admin-event-name">TOP SPORT EVENTS</p>

      <div className="add-event-div">
        <div style={{ display: "flex" }}>
          <NavLink
            style={{ marginRight: "15px" }}
            className="topAll-events-text"
            to="/admin/sport"
          >
            All events
          </NavLink>
          ...
          <NavLink
            className="topAll-events-text add-event-text-active"
            to="/admin/sport/top"
          >
            Top Events
          </NavLink>
      ...
      <div className="row">
        {topEvent.map((d) => (
          <div className="col-lg-4 col-sm-12 mt-5" key={d.EventId}>
            <div className="card mycard mycardSport">
              <div className="card-body">
                ...
                <Link to={`/admin/sport/${d.EventId}`} className="edit_event">
                  რედაქტირება
                  <svg
                    width="20px"
                    height="20px"
